...
export function CustomerBillingRoute(props: CustomerBillingRouteProps) {
  ...
  const canPause = canManageBilling && hasSubscriptionLink;
          ...
          <Group justify="space-between" wrap="wrap" gap="xs">
            ...
            <Group gap="xs" wrap="wrap">
              ...
              {canPause && (
                ...
                >
                  {isPaused ? 'Återuppta abonnemang' : 'Pausa abonnemang'}
                </Button>
              )}
            </Group>
          </Group>
          ...
          >
            {balance.balance_ore < 0 ? (
              <>
                ...
                som dras automatiskt på nästa faktura.
              </>
            ) : (
              <>
                Kunden har en utestående skuld på{' '}
                <strong>
        ...
        <>
          ...
          {canPause && (
            <PauseSubscriptionModal
              ...
              pausedUntil={null}
              nextInvoiceDate={data.next_invoice_date}
              nextInvoiceAmountOre={data.monthly_price_ore}
            />
          )}
        </>
      )}
