    ...
    >
      ...
      <div className="divide-y divide-border">
        {items.map((customer) => {
          ...
          const fullName = hasAssignedCm ? customer.cm_full_name! : 'Ej tilldelad';
          // Only split into first name when we actually have an assigned CM —
          // otherwise "Ej tilldelad".split(' ')[0] would render as "Ej" and
          // mangle the fallback.
          const cmDisplayName = hasAssignedCm ? fullName.split(' ')[0] : 'Ej tilldelad';
