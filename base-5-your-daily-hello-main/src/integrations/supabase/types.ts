  ...
  public: {
    Tables: {
      ...
      admin_customer_action_locks: {
        ...
        Relationships: [
          {
            foreignKeyName: "admin_customer_action_locks_customer_profile_id_fkey"
          ...
          },
          {
            ...
            columns: ["customer_profile_id"]
            isOneToOne: false
            referencedRelation: "v_admin_customer_list"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "admin_customer_action_locks_customer_profile_id_fkey"
            columns: ["customer_profile_id"]
            isOneToOne: false
            referencedRelation: "v_admin_unmatched_account_managers"
          ...
          },
          {
            ...
            columns: ["customer_profile_id"]
            isOneToOne: false
            referencedRelation: "v_customer_pulse"
            referencedColumns: ["customer_id"]
          },
        ]
      }
        ...
        Relationships: [
          {
            ...
            isOneToOne: false
            referencedRelation: "admin_team_overview"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "attention_snoozes_snoozed_by_admin_id_fkey"
          ...
          },
          {
            ...
            columns: ["snoozed_by_admin_id"]
            isOneToOne: false
            referencedRelation: "v_admin_payroll_period"
          ...
          },
          {
            ...
            columns: ["snoozed_by_admin_id"]
            isOneToOne: false
            referencedRelation: "v_admin_team_overview"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      customer_subscription_history: {
        Row: {
          ...
          metadata: Json
          mode: string
          next_price_ore: number
          previous_price_ore: number
        ...
        Relationships: [
          {
            foreignKeyName: "customer_subscription_history_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "customer_profiles"
            referencedColumns: ["id"]
      ...
      customer_upcoming_price_changes: {
        Row: {
          created_at: string
          created_by: string | null
          customer_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "customer_upcoming_price_changes_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: true
            referencedRelation: "customer_profiles"
            referencedColumns: ["id"]
      ...
      demos: {
        ...
        Relationships: [
          {
            foreignKeyName: "demos_converted_customer_id_fkey"
      ...
      invoice_line_items: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["stripe_invoice_id"]
            isOneToOne: false
            referencedRelation: "v_admin_invoices"
            referencedColumns: ["stripe_invoice_id"]
          },
        ]
      }
      ...
      pending_invoice_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "pending_invoice_items_customer_profile_id_fkey"
            columns: ["customer_profile_id"]
            isOneToOne: false
            referencedRelation: "customer_profiles"
            referencedColumns: ["id"]
      ...
      stripe_sync_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "stripe_sync_events_customer_profile_id_fkey"
            columns: ["customer_profile_id"]
            isOneToOne: false
            referencedRelation: "customer_profiles"
            referencedColumns: ["id"]
    ...
    Views: {
      admin_team_overview: {
        Row: {
          active_absence_backup_cm_id: string | null
          active_absence_compensation_mode: string | null
          active_absence_ends_on: string | null
          active_absence_id: string | null
          active_absence_note: string | null
          active_absence_starts_on: string | null
          active_absence_type: string | null
          activity_events_30d: number | null
          activity_events_7d: number | null
          avatar_url: string | null
          bio: string | null
          city: string | null
          ...
          customer_load_level: string | null
          email: string | null
          id: string | null
          is_active: boolean | null
          mrr_ore: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "cm_absences_backup_cm_id_fkey"
            columns: ["active_absence_backup_cm_id"]
            isOneToOne: false
            referencedRelation: "admin_team_overview"
            referencedColumns: ["id"]
          },
      ...
      v_admin_subscription_summary: {
        Row: {
          mrr_30d_ago_ore: number | null
          mrr_now_ore: number | null
        }
        Relationships: []
      }
      ...
      v_admin_unmatched_account_managers: {
        Row: {
          account_manager: string | null
          business_name: string | null
          customer_id: string | null
    ...
    Functions: {
      ...
      admin_create_customer: {
        Args: {
          ...
          p_account_manager_profile_id?: string
          p_actor_email?: string
          p_actor_role?: string
          p_actor_user_id?: string
          p_billing_day_of_month?: number
          p_business_name: string
          p_concepts?: Json
          p_contact_email: string
          p_contacts?: Json
          p_contract_start_date?: string
          p_customer_contact_name?: string
          p_discount_duration_months?: number
          p_discount_end_date?: string
          p_discount_start_date?: string
          p_discount_type?: string
          p_discount_value?: number
          p_first_invoice_behavior?: string
          p_game_plan?: Json
          p_invoice_text?: string
          p_monthly_price?: number
          p_phone?: string
          p_price_end_date?: string
          p_price_start_date?: string
          p_pricing_status?: string
          p_profile_data?: Json
          p_scope_items?: Json
          p_subscription_interval?: string
          p_tiktok_handle?: string
          p_tiktok_profile_url?: string
          p_upcoming_monthly_price?: number
          p_upcoming_price_effective_date?: string
        }
        Returns: Json
      }
      admin_get_customer_detail: { Args: { p_id: string }; Returns: Json }
      admin_get_customer_invoices_with_lines: {
        Args: { p_customer_id: string; p_limit?: number }
        Returns: Json
      }
      admin_get_customer_list: {
        Args: {
          p_filter?: string
          p_limit?: number
          p_offset?: number
      ...
      admin_get_team_overview: { Args: { p_sort_mode?: string }; Returns: Json }
      admin_reassign_team_customers: {
        Args: {
          p_actor_email?: string
          p_actor_role?: string
          p_actor_user_id?: string
          p_customer_ids?: string[]
          p_source_cm_id: string
          p_target_cm_id: string
        }
        Returns: Json
      }
      ...
      derive_customer_status:
        | {
            Args: {
              ...
              p_concepts_per_week: number
              p_escalation_flag?: boolean
              p_invited_at: string
              p_latest_planned_publish_date: string
