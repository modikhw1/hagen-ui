...
/**
 * Genererar en invite-länk utan att skicka mejl. Adminen kan kopiera länken
 * och skicka via valfri kanal (Slack, SMS, manuell e-post) som backup om
 * Supabase-mejlet inte når fram.
 */
export async function handleCopyInviteLink(ctx: AdminActionContext): Promise<ActionResult> {
