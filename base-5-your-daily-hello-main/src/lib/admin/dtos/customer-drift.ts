...
/**
 * Shapes the data the Drift tab needs about a customer.
 * Lives in /lib so it can be referenced by both server loaders
 * and route components without coupling them to each other.
 */
