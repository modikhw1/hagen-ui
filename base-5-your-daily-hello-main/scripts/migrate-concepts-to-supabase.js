 ...
 *
 * Usage:
 *   node app/scripts/migrate-concepts-to-supabase.js
 *
 * Or add to package.json:
 *   "migrate:concepts": "node scripts/migrate-concepts-to-supabase.js"
 */
...
async function main() {
  ...
  const jsonPath = path.join(__dirname, '../src/data/clips-priority.json');
  ...
  const clipsData = JSON.parse(fs.readFileSync(jsonPath, 'utf-8'));
