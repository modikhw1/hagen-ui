    ...
    >
      <Container size="xl">
        <Group h={60} justify="space-between">
          ...
          >
            <IconSparkles size={24} color="var(--lt-brown-dark)" />
            <Text fw={700} size="lg" c="var(--lt-brown-dark)">
              LeTrend
            </Text>
          </Group>
          ...
          <Group gap="xs">
            {navLinks.map((link) => (
              <Button
                ...
                style={isActive(link.href) ? { backgroundColor: "var(--lt-brown-dark)" } : undefined}
                color={isActive(link.href) ? undefined : "gray"}
              >
                {link.label}
              </Button>
            ))}
          ...
          <Menu shadow="md" width={220} position="bottom-end">
            <Menu.Target>
              <Button variant="subtle" color="gray" px="xs">
                <Group gap="sm">
                  <Avatar size="sm" style={{ backgroundColor: "var(--lt-brown-dark)" }} radius="xl">
