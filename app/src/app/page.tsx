...
import { loadGamePlan, formatGamePlanDate, type GamePlanNote, type LinkType } from '@/lib/gameplanLoader';
...
// ============================================
// GAME PLAN SECTION - Strategy notes from advisor
// ============================================
      ...
      <div style={{
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              <div style={{ fontSize: '15px', fontWeight: '600', color: '#1A1612' }}>
                Anteckningar för {gamePlan.brandHandle}
              </div>
              <div style={{ fontSize: '12px', color: '#9D8E7D' }}>
                Uppdaterad {formatGamePlanDate(gamePlan.lastUpdated)}
              </div>
            </div>
          </div>
          <span style={{
