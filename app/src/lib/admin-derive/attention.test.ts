...
describe('attention', () => {
  it('prioritizes urgent notifications and old invoices', () => {
    const items: AttentionItem[] = [
      { kind: 'customer_blocked', id: 'blocked', customerId: 'c1', customerName: 'Cafe Ros', daysBlocked: 12, subjectType: 'customer_blocking', subjectId: 'c1' },
      { kind: 'invoice_unpaid', id: 'invoice', customerId: 'c2', customerName: 'Bar Central', invoiceNumber: 'INV-100', daysPastDue: 20, amount_ore: 100_000, hostedInvoiceUrl: null, subjectType: 'invoice', subjectId: 'in_123' },
