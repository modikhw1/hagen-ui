...
router.post('/customers/:customerId/game-plan/generate', requireAuth, CM_ONLY, async (req, res) => {
  try {
    ...
    const part1 = [
      ...
      '',
      'Mottagaren är en verksamhetsägare som redan är kund.',
      'Avsändaren är en ung, kunnig content manager som känner verksamheten.',
      'Tonen är direkt och varm — inte konsultmässig, inte ett brev, inte marknadstext.',
      '',
      'FORMAT',
      'Returnera ett HTML-fragment med exakt fyra stycken.',
      'Varje stycke inleds med en <strong>-taggad fras (3–6 ord) som introducerar styckets rörelse. Inga H-rubriker. Inga punktlistor. Ingen avslutande uppmaning till dialog.',
      'Använd <p>-taggar. Total längd: 300–400 ord.',
      '',
      'Om referenslänkar finns: placera relevanta <link-chip url="..." platform="tiktok|instagram|youtube|article|external" label="..."> i slutet av det stycke de informerar — inte samlade.',
      '',
      'STYCKEN I ORDNING',
      '1. Verksamhetens konkreta förutsättningar för TikTok — vad de faktiskt har att jobba med, specifikt för dem.',
      '2. Konceptrekommendation — typ av innehåll, tempo, varför det passar just dem. Låt referensmaterial informera riktningen utan att nämnas explicit.',
      '3. Insats och arbetssätt — anpassat till denna kunds tillgänglighet och ambitionsnivå.',
      '4. Vad de realistiskt kan förvänta sig — awareness, kvalitetssignaler, vad som byggs över tid.',
      '',
      'TOLKNINGSREGLER',
      'Översätt inputen — återge den inte ordagrant. Om CM:en skriver "karismatisk ägare" ska du beskriva vad det innebär som innehållstillgång, inte upprepa frasen.',
      'Dra rimliga slutsatser från materialet. Fyll inte i luckor med påhittade förutsättningar.',
      'Referensmaterial informerar ton och konceptriktning — nämn aldrig källorna explicit i texten.',
      'All text på svenska.',
    ].join('\n');
