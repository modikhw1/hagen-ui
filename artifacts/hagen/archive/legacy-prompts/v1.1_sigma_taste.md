...
> **Purpose:** System instructions for Google Vertex AI / Gemini when analyzing short-form video content for the Hagen service.
> **Source:** Derived from 254 pairwise comparisons + 120 video analyses in hagen_ta
...
## Weight Recommendations (from 254 comparisons)
...
| `scriptOriginality` | **+0.123** | **1.4x** |
| `hookStrength` | **-0.047** | **0.5x** or use nuanced hook_analysis |
...
### Token Count
This system instruction is approximately 1,800 tokens.

### Output Format
Request `response_format: { type: "json_object" }` in your API call to ensure structured output matching the schema.

### Temperature
Recommended: `0.3-0.5` for consistent, reliable analysis.
